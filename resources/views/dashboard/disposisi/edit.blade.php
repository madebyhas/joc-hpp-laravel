                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <!-- Jika tidak ada catatan atau catatan tidak mengandung id_pegawai yang sama dengan user yang sedang login, tampilkan tombol -->
                                    <button class="btn btn-primary btn-round ms-auto" data-bs-toggle="modal"
                                        data-bs-target="#modal-add" data-id_dispo="{{ $disposisi->id_dispo }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('catatan-disposisi.update', $catatan->id) }}" method="POST">
                    ...
                    <!-- Submit button -->
                    <div class="text-end">
                        <a href="{{ route('disposisi.index') }}" class="btn btn-rounded btn-warning col-lg-4">Cancel</a>
